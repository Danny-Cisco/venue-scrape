...
<div class="flex flex-col min-h-screen text-gray-800">
	...
	<div class="flex flex-1">
		...
		<!-- Right Sidebar -->
		<aside class="w-[300px] p-4 bg-gray-200">
			<div class="w-[250px] mx-auto">
				...
				<div
					class="bg-gray-100 text-gray-500 border-[magenta] relative border-2 rounded-lg h-[144px] w-[250px] flex flex-col items-center justify-center"
				>
					captured image
					<CapturedImageFly />
				</div>
